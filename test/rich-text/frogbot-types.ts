...
export interface Config {
  auth: {
    'rich-text-users': RichTextUserAuthOperations;
  };
  blocks: {};
  collections: {
...
export interface RichTextUserAuthOperations {
  forgotPassword: {
    email: string;
    password: string;
  };
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "rich-text-users".
 */
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "rich-text-html-articles".
 */
export interface RichTextHtmlArticle {
  id: number;
  title: string;
  content: {
    root: {
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "rich-text-users_select".
 */
export interface RichTextUsersSelect {
  name?: boolean;
  updatedAt?: boolean;
  createdAt?: boolean;
  email?: boolean;
...
/**
 * This interface was referenced by `Config`'s JSON-Schema
 * via the `definition` "rich-text-html-articles_select".
 */
export interface RichTextHtmlArticlesSelect {
  title?: boolean;
  content?: boolean;
  contentHTML?: boolean;
  customHTML?: boolean;
