...
| `within`             | For Point Fields, filters documents based on whether points are inside the given area defined in GeoJSON.                                             |
| `intersects`         | For Point Fields, filters documents based on whether points intersect with the given area defined in GeoJSON.                                         |
