...
Documents in FrogBot can be easily sorted by a specific [Field](/fields/overview). When querying Documents, you can pass the name of any top-level field, and the response will sort the Documents by that field in _ascending_ order.
