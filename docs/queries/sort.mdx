...
Documents in FrogBot can be sorted by a specific [Field](/fields/overview). When querying Documents, pass the name of any top-level field to sort the Documents by that field in ascending order.
