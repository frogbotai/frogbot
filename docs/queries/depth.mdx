...
<Note>
  This is the same for [Globals](/configuration/globals) using the `findGlobal`
  operation.
</Note>
...
<Note>
  This is the same for [Globals](/configuration/globals) using the `/api/globals`
  endpoint.
</Note>
