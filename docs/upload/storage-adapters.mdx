...
order: 20
desc: FrogBot provides additional storage adapters to handle file uploads. These adapters allow you to store files in different locations, such as Amazon S3, Vercel Blob Storage, Google Cloud Storage, Uploadthing, and more.
...
| Service              | Package                                                                                                           |
| -------------------- | ----------------------------------------------------------------------------------------------------------------- |
| Vercel Blob          | [`@frogbot/storage-vercel-blob`](https://github.com/frogbot/frogbot/tree/main/packages/storage-vercel-blob) |
| AWS S3               | [`@frogbot/storage-s3`](https://github.com/frogbot/frogbot/tree/main/packages/storage-s3)                   |
| Azure                | [`@frogbot/storage-azure`](https://github.com/frogbot/frogbot/tree/main/packages/storage-azure)             |
| Google Cloud Storage | [`@frogbot/storage-gcs`](https://github.com/frogbot/frogbot/tree/main/packages/storage-gcs)                 |
| Uploadthing          | [`@frogbot/storage-uploadthing`](https://github.com/frogbot/frogbot/tree/main/packages/storage-uploadthing) |
| R2                   | [`@frogbot/storage-r2`](https://github.com/frogbot/frogbot/tree/main/packages/storage-r2)                   |
...
```sh
npx @frogbot/codemod --transform migrate-storage-adapters-to-config
```
...
[`@frogbot/storage-vercel-blob`](https://www.npmjs.com/package/@frogbot/storage-vercel-blob)
...
[`@frogbot/storage-s3`](https://www.npmjs.com/package/@frogbot/storage-s3)
...
Cloudflare R2 exposes an S3-compatible API, so you can use `@frogbot/storage-s3` to connect to it. This is the recommended approach when deploying to Vercel, Netlify, or any Node.js environment. (The `@frogbot/storage-r2` adapter is for Cloudflare Workers only, where R2 is available as a native bucket binding.)
...
[`@frogbot/storage-azure`](https://www.npmjs.com/package/@frogbot/storage-azure)
...
[`@frogbot/storage-gcs`](https://www.npmjs.com/package/@frogbot/storage-gcs)
...
[`@frogbot/storage-uploadthing`](https://www.npmjs.com/package/@frogbot/storage-uploadthing)
...
[`@frogbot/storage-r2`](https://www.npmjs.com/package/@frogbot/storage-r2)
...
If you need to create a custom storage adapter, you can use the [`@frogbot/plugin-cloud-storage`](https://www.npmjs.com/package/@frogbot/plugin-cloud-storage) package. This package is used internally by the storage adapters mentioned above.

### Installation#custom-installation

`pnpm add @frogbot/plugin-cloud-storage`
...
```ts
import { buildConfig } from 'frogbot'
import { cloudStoragePlugin } from '@frogbot/plugin-cloud-storage'
