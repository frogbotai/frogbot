...
description: "Add indexes to FrogBot fields to speed up queries and enforce uniqueness."
---
...
FrogBot creates a non-sparse unique index. Documents that do not contain the
...
`validate` function on the array field
instead.
