...
title: "SQLite"
sidebarTitle: "SQLite"
description: "Use SQLite with FrogBot through the @frogbot/db-sqlite adapter, which wraps @frogbot/db-sqlite on top of Drizzle."
---

To use FrogBot with SQLite, install the package `@frogbot/db-sqlite`. It leverages Drizzle ORM and `libSQL` to interact with a SQLite database that you provide.
...
import { eq, sql, and } from '@frogbot/db-sqlite/drizzle'
...
```ts
import { sqliteAdapter } from '@frogbot/db-sqlite'
import { integer, sqliteTable } from '@frogbot/db-sqlite/drizzle/sqlite-core'
...
```ts
import { sqliteAdapter } from '@frogbot/db-sqlite'
import { index, integer } from '@frogbot/db-sqlite/drizzle/sqlite-core'
...
To use it, install the package `@frogbot/db-d1-sqlite` and configure it as follows:
