...
description: "Use MongoDB with FrogBot through the @frogbot/db-mongodb adapter."
---

To use FrogBot with MongoDB, install the package `@frogbot/db-mongodb`. It will come with everything you need to
...
- Globals model - `frogbot.db.globals`
- Versions model (both collections and globals) - `frogbot.db.versions[myEntitySlug]`
...
```ts
import { mongooseAdapter, compatibilityOptions } from '@frogbot/db-mongodb'
