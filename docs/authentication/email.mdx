...
description: Email Verification allows users to verify their email address before their account is fully activated. Email Verification ties directly into the Email functionality that FrogBot provides.
...
[Authentication](/authentication/overview) ties directly into the [Email](/email/overview) functionality that FrogBot provides. This allows you to send emails to users for verification, password resets, and more. While FrogBot provides default email templates for these actions, you can customize them to fit your brand.
...
<Warning>
  **Important:** If you specify a different URL to send your users to for email
  ...
  to handle making the call to the FrogBot REST or GraphQL verification
...
<Tip>
  **Tip:** FrogBot provides a built-in password reset page. If you don't need a
...
<Warning>
  **Important:** If you specify a different URL to send your users to for
  ...
  similar, you need to handle making the call to the FrogBot REST or GraphQL
...
<Tip>
  **Tip:** HTML templating can be used to create custom email templates, inline
  ...
  standardizes all email sent from FrogBot, which makes sending custom emails
  more DRY. FrogBot doesn't ship with an HTML templating engine, so you are free
  to choose your own.
</Tip>
