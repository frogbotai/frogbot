...
Field Hooks are [Hooks](/hooks/overview) that run on Documents on a per-field basis. They allow you to execute your own logic during specific events of the Document lifecycle. Field Hooks offer incredible potential for isolating your logic from the rest of your [Collection Hooks](/hooks/collections) and [Global Hooks](/hooks/globals).
...
<Warning>
  ...
  Hooks](/hooks/collections) or [Global Hooks](/hooks/globals) instead.
</Warning>
